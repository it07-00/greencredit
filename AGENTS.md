# AGENTS.md — Green Credit Platform

> File này đặt ở **root project** để Codex/Cursor/AI coding agent đọc và triển khai toàn bộ dự án **Green Credit Platform** bằng **Laravel + Livewire + Tailwind CSS + MySQL**.
